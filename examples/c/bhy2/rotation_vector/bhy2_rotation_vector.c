 ...
 *
 * @file    bhy2_rotation_vector.c
 * @date    Dec-10-2018
 * @version 1.1
 * @brief   Sample file how to display rotaion vector using BHY2 
 *          with LIB COINES
 *
 */
/*********************************************************************/
...
#ifdef BHA260
#include "Bosch_SHUTTLE_BHA260_BMG250_AK09915.h"
#endif
...
{
    bhy2_virt_sensor_callback_register( p_bhy2_hub, BHY_SENSOR_ID_RV, bhy2_parse_frame_rotation );
    bhy2_virt_sensor_callback_register( p_bhy2_hub, BHY_SENSOR_ID_RV_WU, bhy2_parse_frame_rotation_wkup);
    bhy2_virt_sensor_callback_register( p_bhy2_hub, BHY_SENSOR_ID_GAMERV, bhy2_parse_frame_game_rotation );
    bhy2_virt_sensor_callback_register( p_bhy2_hub, BHY_SENSOR_ID_GAMERV_WU, bhy2_parse_frame_game_rotation_wkup);
...
int main(void)
{
    ...
    ASSERT ( bhy2_virt_sensor_cfg_set(&bhy2_hub_obj,BHY_SENSOR_ID_RV,sample_rate, 0) );

    TST_PRINT("enable RV sensor as %f HZ\r\n",sample_rate);
