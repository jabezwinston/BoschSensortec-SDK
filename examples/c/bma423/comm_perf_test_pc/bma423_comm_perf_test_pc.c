 ...
 *
 * @file    bma423_comm_perf_test.c
 * @brief 	Sample file how to test BMA423 communication, functionality 
...
/*! typical value for this parameter is 80mg for BMA423 */
#define OFFSET_THRESHOLD_MG		200.0

/*! defines the PASS threshold for the noise density test */
/*! typical value for this parameter is 140ug/sqrt(Hz) for BMA423 */
#define NOISE_THRESHOLD_MG		210.0
...
/*!
 * @brief	 This internal API is used to initialize the bma423 and test communication
 */
 ...
 */
static void perf_test_bma423(void);
...
int main(int argc, char *argv[])
{
    ...
    init_comm_test_bma423();

    /* performs sensor function test */
    function_test_bma423();
