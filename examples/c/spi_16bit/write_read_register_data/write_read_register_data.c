...
int main(int argc, char *argv[])
{
	...
	{
		rslt = coines_write_16bit_spi(COINES_SHUTTLE_PIN_7, reg_addr, write_data,word_count);
		...
		rslt = coines_read_16bit_spi(COINES_SHUTTLE_PIN_7,reg_addr,read_data,word_count);
		if (rslt == COINES_SUCCESS)
		{
			printf("\tRead data:");
			for(index = 0; index < word_count; index++)
