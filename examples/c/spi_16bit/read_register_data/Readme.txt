...
#####################################################################################################
Read sensor data
1. Initialize the application/board communication interface (USB) using coines API
2. Initialize the sensor SPI interface
3. Wait for 200ms 
4. Read sensor using coines_read_16bit_spi() COINES API and print it on console for some iteration.
