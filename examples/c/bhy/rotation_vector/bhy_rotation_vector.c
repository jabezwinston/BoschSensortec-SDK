 ...
 * @brief This demo streams the absolution rotation vector to a terminal program on the computer at 25hz sampling rate
 */
...
char outBuffer[60] = " W: 0.999  X: 0.999  Y: 0.999  Z: 0.999   \r";
...
int main(void)
{
    ...
    coines_delay_msec(5); // precaution: wait a few ms (i2C might not be ready yet after init / RAM patch upload)
