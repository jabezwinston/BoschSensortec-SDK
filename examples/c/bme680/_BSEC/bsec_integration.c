...
static void hardware_init(void)
{
    ...
    if (coines_open_comm_intf(COINES_COMM_INTF_USB) < 0)
    {
    ...
    bme680_g.read = coines_read_i2c;
    bme680_g.write = coines_write_i2c;
    ...
    bme680_g.read = coines_read_spi;
    bme680_g.write = coines_write_spi;
    bme680_g.delay_ms = coines_delay_msec;
