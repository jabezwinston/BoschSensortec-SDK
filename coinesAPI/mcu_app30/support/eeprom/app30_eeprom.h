...
#ifndef PLATFORM_EEPROM_NUWA_EEPROM_H_
#define PLATFORM_EEPROM_NUWA_EEPROM_H_
...
/*!
 *
 * @brief       : API initialize Nüwa EEPROM
 *
 * @param[in]   : None
 *
 * @return      : None
 ...
 */
bool nuwa_eeprom_romid(uint8_t *buffer);
/*!
 *
 * @brief       : API to read Nüwa EEPROM
 *
...
/*!
 *
 * @brief       : API to write Nüwa EEPROM
 *
 * @param[in]   : address,pointer to the buffer,length
 *
 * @return      : true/false
